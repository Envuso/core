import {ObjectContainerContract} from "../Contracts/Common/ObjectContainerContract";
...
export class ObjectContainer<T> implements ObjectContainerContract<T> {
	 ...
	 */
	public put(key: string, value: any): ObjectContainerContract<T> {
		key   = this.convertKey(key);
		value = this.convertValue(value) as T;
	 ...
	 * @return {ObjectContainer}
	 */
	public forget(key: string): ObjectContainerContract<T> {
